...
> 最近一次更新：2026-06-26（雙向通聯格式支援 + 小檔守門放寬；對齊 commit 8cf7b7d）
...
pytest app/tests/ -v                                      # 全部（248 passed）
...
> **涵蓋範圍**（2026-05-26 已大幅補強，131 → 203；2026-05-30 → 216；2026-06-04 → 229；2026-06-06 → 234；2026-06-08 → 237；2026-06-13 → 242；2026-06-26 → 248）：
